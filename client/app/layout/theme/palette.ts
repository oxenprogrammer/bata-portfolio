...
// TODO: Update custom colors for the rest of the palette.
...
export const palette: ThemeOptions["palette"] & typeof customColors = {
  divider: customColors.navy[30],
  mode: "dark",
  primary: {
    dark: customColors.black[80],
    main: customColors.black[50],
    light: customColors.gray[50],
  },
  secondary: {
  ...
  text: {
    ...
    secondary: customColors.gray[30],
    disabled: customColors.gray[50],
  },
  common: {
    black: customColors.black[80],
    white: customColors.white,
  },
  background: {
    default: customColors.black[100],
  },
  ...customColors,
};
