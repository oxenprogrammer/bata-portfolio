...
const content = {
  ...
  darkShadowSm: [
    "0px 0.2037px 0.62963px 0px rgba(61, 78, 133, 0.07)",
    "0px 4.23704px 8.1px 0px rgba(61, 78, 133, 0.06)",
    "0px 7.12963px 18.37px 0px rgba(61, 78, 133, 0.05)",
    "0px 11px 30px 0px rgba(61, 78, 133, 0.04)",
  ],
  blueShadowMd: [
    "0px 11px 30px 0px rgba(61, 78, 133, 0.04)",
    "0px 7.13px 18.37px 0px rgba(61, 78, 133, 0.05)",
    "0px 4.237px 8.1px 0px rgba(61, 78, 133, 0.06)",
    "0px 0.204px 0.63px 0px rgba(61, 78, 133, 0.07)",
  ],
};
...
export const boxShadows = {
  ...
  darkShadowSm: content.darkShadowSm.join(","),
  blueShadowMd: content.blueShadowMd.join(","),
};
...
export const dropShadows = {
  ...
  darkShadowSm: toDropShadow("darkShadowSm"),
  blueShadowMd: toDropShadow("blueShadowMd"),
};
