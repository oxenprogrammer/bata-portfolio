...
const TickerAnimation: FC<InfiniteCarouselProps> = memo((props: InfiniteCarouselProps) => {
  const { children, duration = 3000, isPlaying = true, direction = TICKER_DIRECTION_LEFT } = props;
  ...
  return (
    <CarouselContainer ref={tickerRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
...
export const InfiniteCarousel: FC<InfiniteCarouselImageProps> = ({ images, duration = 60 }) => {
